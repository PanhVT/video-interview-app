      ...
      <div className="preview-window theme-transition">
        <div className="preview-header">
          <div>
            ...
            <p className="preview-subtitle">Check your camera and microphone before you begin.</p>
          </div>
        ...
        <div className="preview-actions">
          <button className="preview-btn secondary" onClick={()=>nav('/')}>Back</button>
          <button className="preview-btn primary" onClick={()=>nav('/guide')}>Interview Instructions</button>
        </div>
      </div>
    </div>
  )
